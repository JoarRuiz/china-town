      ...
      <div class="menu">
        ...
        <ul>
          ...
          <li :class="{ 'active': $route.path === '/user/usermesascancelado' }">
            <router-link to="/user/usermesascancelado" style="color: rgb(0, 0, 0); font-weight: bold;">Mesas</router-link>
          </li>
    ...
    <div class="Mesas">
      <div class="rectangulo">
        <div class="Reserva">
          <ul>
            <li :class="{ 'active': $route.path === '/user/usermesasreserva' }">
              <router-link to="/user/usermesasreserva" style="color: black;">Mi Reserva</router-link>
            </li>
          </ul>
        </div>
        ...
        <div class="Cancelado">
          <ul>
            <li :class="{ 'active': $route.path === '/user/usermesascancelado' }">
              <router-link to="/user/usermesascancelado" style="color: black; font-weight: bold;">Cancelado</router-link>
            </li>
          </ul>
        </div>
      </div>
