    ...
    <div class="Pedido">
      <div class="rectangulo">
        <div class="Reserva">
          <ul>
            <li :class="{ 'active': $route.path === '/user/userpedidosproceso' }">
              <router-link to="/user/userpedidosproceso" style="color: black; ">En proceso</router-link>
            </li>
          </ul>
        </div>
        <div class="Completado">
          <ul>
            <li :class="{ 'active': $route.path === '/user/userpedidosentregado' }">
              <router-link to="/user/userpedidosentregado"
                style="color: black; font-weight: bold;">Entregado</router-link>
            </li>
          </ul>
        </div>
      </div>
